 ...
 *       Class: CSC340.02
 *      Assign: Homework 8, part 1 -- ADT 
 *        Date: 05/08/15
 * 
 * Description: The purpose of this program is to test the implementation of 
 *              dynamic arrays. It consists of list.h, listExceptions.h, list.cpp
 *              and test-list.cpp. It is designed to handle a vector of doubles. 
